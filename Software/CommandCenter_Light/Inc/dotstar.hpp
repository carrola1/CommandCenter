...
#define Data_Port DOTSTAR_DATA_GPIO_Port
#define Data_Pin DOTSTAR_DATA_Pin
#define Clock_Port DOTSTAR_CLK_GPIO_Port
#define Clock_Pin DOTSTAR_CLK_Pin
...
class DotStar {
 ...
 public:
    ...
    DotStar(uint8_t n, uint8_t o=DOTSTAR_RBG);
   ~DotStar(void);
  void
